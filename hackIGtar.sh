...
echo -e "	\e[1;37m║║║│ ┬├┤ ╠═╣├┤ ├┴┐───║║ ╦\e[1;37m \e[1;31mAuthor : Mr.Gaming\e[1;37m"
echo -e "	\e[1;34m╝╚╝└─┘└─┘╩ ╩└─┘┴ ┴   ╩╚═╝\e[1;37m \e[1;31mYoutube : Jomblo Kawe\e[1;37m"
echo ""
echo ""
echo -e '''
...
'''
xdg-open https://www.youtube.com/channel/UCzWOSICWhsyn9rH3siTDtuQ?view_as=subscriber
echo ""
echo ""
